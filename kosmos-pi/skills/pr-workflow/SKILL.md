...
Before declaring the PR ready, run a self-review pass. Delegate to specialists using the `subagent(...)` tool (the `pi-subagents` package) — spawn reviewers in parallel:
